...
- [OVerall Candy Rnakings](#overall-candy-rnakings)
...
Nik L Nip, Ring pop, Nestle Smarties, Hershey’s Krackel, and Hershey’s
Milk Chocolate. The least popular is Nik L Nip.
...
The function to use is called `prcom()` with an optional `scale=T/F`
argument.
...
We should also examine the varibale “loadings” or contributions of the
...
Fruity is being picked up strongly by PC1. This makes sense because it
is a clear categorical distinction.
...
with **ploty** package. It’s output is interactive and will not render
to PDF :-(
