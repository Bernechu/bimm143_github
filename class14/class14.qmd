...
Lots of folks like the reactome web interface. You can also run this as an R function bu tlets look at the website first. <https://reactome.org/>

The website wants a text file with one gene symbol per pline of the genes you want to map to pathways.
